      ...
      <div className="flex items-center justify-center py-16">
        <Card className="p-6 bg-red-900/20 border-red-500/20">
          <div className="text-red-400 text-center">
            <p className="font-semibold">Error loading points data</p>
        ...
        <Card className="p-6 bg-gradient-to-br from-green-900/20 to-green-800/20 border-green-500/20 backdrop-blur-xl">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-white">${totalVolume.toLocaleString(undefined, { maximumFractionDigits: 2 })}</p>
            </div>
          </div>
        </Card>
